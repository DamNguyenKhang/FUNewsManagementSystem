...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    private string GetConnectionString()
    {
        ...
        return configuration.GetConnectionString("FUNewsManagement");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NewsArticle>(entity =>
        {
            ...
            entity.Property(e => e.NewsArticleImage).HasMaxLength(400);
            ...
            entity.HasOne(d => d.CreatedBy).WithMany(p => p.NewsArticles)
                ...
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_NewsArticle_SystemAccount_CreatedBy");
        ...
        modelBuilder.Entity<SystemAccount>(entity =>
        {
            ...
            entity.Property(e => e.AccountRole).IsRequired().HasConversion<int>();
        });
